						...
						@foreach ($tabla_anexos as $key => $tabla_anexo)
							<tr>
								@foreach ($tabla_anexo as $key => $anexo)
									<td><center>
											<center><a href="#"  class='{{ $anexo['btn']  }}' onclick="assignAnexxed('{{ $anexo['name'] }}');" >
											<center><img class="img-responsive" width="74" height="74" name={{ $anexo['name'] }}  src={{ asset('cosapi/img/'.$anexo['image']) }}  /></center>
