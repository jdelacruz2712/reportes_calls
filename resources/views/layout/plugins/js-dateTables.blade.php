<!--js para la tabla que exporta al excel-->
...
<script type="text/javascript" src="{{ asset('plugins/datatables/DataTables-1.10.12/js/dataTables.bootstrap.min.js')}}"></script>

<script type="text/javascript" src="{{ asset('plugins/datatables/Select-1.2.0/js/dataTables.select.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('plugins/datatables/FixedColumns-3.2.2/js/dataTables.fixedColumns.min.js')}}"></script>
...
<script type="text/javascript" src="{{ asset('plugins/datatables/Buttons-1.2.1/js/dataTables.buttons.min.js')}}"></script>
...
<script type="text/javascript" src="{{ asset('plugins/datatables/Buttons-1.2.1/js/buttons.print.min.js')}}"></script>

<script type="text/javascript" src="{{ asset('plugins/datatables/ColReorder-1.3.2/js/dataTables.colReorder.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('plugins/datatables/KeyTable-2.1.2/js/dataTables.keyTable.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('plugins/datatables/RowReorder-1.1.2/js/dataTables.rowReorder.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('plugins/datatables/Scroller-1.4.2/js/dataTables.scroller.min.js')}}"></script>
