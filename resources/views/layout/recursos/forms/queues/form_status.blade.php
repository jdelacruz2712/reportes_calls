...
<div class="panel panel-primary">
    <div class="panel-heading">
        <button type="button" class="close" onclick="clearModal('modalQueues', 'div.dialogQueues')">&times;</button>
    ...
    <div class="modal-body">
        <form id="formQueuesStatus">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" onclick="clearModal('modalQueues', 'div.dialogQueues')"><i class="fa fa-close"></i> No</button>
            </div>
        </form>
    </div>
</div>
{!!Html::script('js/form/formQueues.min.js')!!}
<script> hideErrorForm('.formError') </script>