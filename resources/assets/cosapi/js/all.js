...
(function (root, factory) {
  ...
  * ================================================ */
	...
	var BootstrapDialogModal = function BootstrapDialogModal(element, options) {
   ...
   * @returns {undefined}
   */
		getGlobalOpenedDialogs: function getGlobalOpenedDialogs() {
			var openedDialogs = [];
  ...
  * ================================================ */
	var BootstrapDialog = function BootstrapDialog(options) {
  ...
  */
	...
	BootstrapDialog.METHODS_TO_OVERRIDE['v3.1'] = {
		handleModalBackdropEvent: function handleModalBackdropEvent() {
   ...
   */
	...
	BootstrapDialog.prototype = {
		...
		holdThisInstance: function holdThisInstance() {
			BootstrapDialog.addDialog(this);

			return this;
		},
		initModalStuff: function initModalStuff() {
		...
		setModalDialog: function setModalDialog($modalDialog) {
			this.$modalDialog = $modalDialog;

			return this;
		},
		createModalContent: function createModalContent() {
		...
		createModalHeader: function createModalHeader() {
			return $('<div class="modal-header"></div>');
		},
		getModalHeader: function getModalHeader() {
			return this.$modalHeader;
		},
		setModalHeader: function setModalHeader($modalHeader) {
			this.$modalHeader = $modalHeader;

			return this;
		},
		createModalBody: function createModalBody() {
			return $('<div class="modal-body"></div>');
		},
		getModalBody: function getModalBody() {
			return this.$modalBody;
		},
		setModalBody: function setModalBody($modalBody) {
			this.$modalBody = $modalBody;

			return this;
		},
		createModalFooter: function createModalFooter() {
			return $('<div class="modal-footer"></div>');
		},
		getModalFooter: function getModalFooter() {
			return this.$modalFooter;
		},
		setModalFooter: function setModalFooter($modalFooter) {
			this.$modalFooter = $modalFooter;

			return this;
		},
		createDynamicContent: function createDynamicContent(rawContent) {
			var content = null;
		...
		formatStringContent: function formatStringContent(content) {
		...
		setClosable: function setClosable(closable) {
			this.options.closable = closable;
			this.updateClosable();

			return this;
		},
		setCloseByBackdrop: function setCloseByBackdrop(closeByBackdrop) {
			this.options.closeByBackdrop = closeByBackdrop;

			return this;
		},
		canCloseByBackdrop: function canCloseByBackdrop() {
			return this.options.closeByBackdrop;
		},
		setCloseByKeyboard: function setCloseByKeyboard(closeByKeyboard) {
			this.options.closeByKeyboard = closeByKeyboard;

			return this;
		},
		canCloseByKeyboard: function canCloseByKeyboard() {
			return this.options.closeByKeyboard;
		},
		isAnimate: function isAnimate() {
			return this.options.animate;
		},
		setAnimate: function setAnimate(animate) {
		...
		getSpinicon: function getSpinicon() {
			return this.options.spinicon;
		},
		setSpinicon: function setSpinicon(spinicon) {
   ...
   */
		...
		isAutodestroy: function isAutodestroy() {
			return this.options.autodestroy;
		},
		setAutodestroy: function setAutodestroy(autodestroy) {
		...
		updateTabindex: function updateTabindex() {
			if (this.isRealized()) {
		...
		getNamespace: function getNamespace(name) {
			return BootstrapDialog.NAMESPACE + '-' + name;
		},
		createHeaderContent: function createHeaderContent() {
		...
		createTitleContent: function createTitleContent() {
			var $title = $('<div></div>');
		...
		createBodyContent: function createBodyContent() {
			var $container = $('<div></div>');
		...
		createMessageContent: function createMessageContent() {
			var $message = $('<div></div>');
			$message.addClass(this.getNamespace('message'));

			return $message;
		},
		createFooterContent: function createFooterContent() {
			var $container = $('<div></div>');
			$container.addClass(this.getNamespace('footer'));

			return $container;
		},
		createFooterButtons: function createFooterButtons() {
			var that = this;
			var $container = $('<div></div>');
		...
		createButton: function createButton(button) {
   ...
   */
		enhanceButton: function enhanceButton($button) {
			$button.dialog = this;
		...
		createButtonIcon: function createButtonIcon(icon) {
			var $icon = $('<span></span>');
   ...
   * @returns {undefined}
   */
		enableButtons: function enableButtons(enable) {
   ...
   * @returns {undefined}
   */
		updateClosable: function updateClosable() {
			if (this.isRealized()) {
				// Close button
   ...
   * This is a setter!
   */
		onShown: function onShown(onshown) {
   ...
   * This is a setter!
   */
		onHidden: function onHidden(onhidden) {
			this.options.onhidden = onhidden;

			return this;
		},
		isRealized: function isRealized() {
			return this.realized;
		},
		setRealized: function setRealized(realized) {
		...
		handleModalEvents: function handleModalEvents() {
		...
		isModalEvent: function isModalEvent(event) {
			return typeof event.namespace !== 'undefined' && event.namespace === 'bs.modal';
		},
		makeModalDraggable: function makeModalDraggable() {
...
(function ($, AdminLTE) {
  ...
  * @type Array
  */
	var my_skins = ["skin-red-light", "skin-blue", "skin-black", "skin-red", "skin-yellow", "skin-purple", "skin-green", "skin-blue-light", "skin-black-light", "skin-yellow-light", "skin-purple-light", "skin-green-light"];
	...
	//Layout options
	demo_settings.append("<h4 class='control-sidebar-heading'>" + "Opciones de Diseño" + "</h4>"
	//Fixed layout
	 + "<div class='form-group'>" + "<label class='control-sidebar-subheading'>" + "<input type='checkbox' data-layout='fixed' class='pull-right'/> " + "Diseño Fijo" + "</label>" + "<p>Active el diseño fijo. No se puede utilizar diseños fijos y cajas juntas</p>" + "</div>"
	//Boxed layout
	 + "<div class='form-group'>" + "<label class='control-sidebar-subheading'>" + "<input type='checkbox' data-layout='layout-boxed'class='pull-right'/> " + "Diseño en Caja" + "</label>" + "<p>Activaci&oacute;n de dise&ntilde;o de caja</p>" + "</div>"
	//Sidebar Toggle
	 + "<div class='form-group'>" + "<label class='control-sidebar-subheading'>" + "<input type='checkbox' data-layout='sidebar-collapse' class='pull-right'/> " + "Activar Barra Lateral" + "</label>" + "<p>Modifcar el estado de la barra izquierda lateral (expandida o minimizado)</p>" + "</div>"
	//Control Sidebar Toggle
	 + "<div class='form-group'>" + "<label class='control-sidebar-subheading'>" + "<input type='checkbox' data-controlsidebar='control-sidebar-open' class='pull-right'/> " + "Fijar Barra Lateral Derecha" + "</label>" + "<p>Fija la barra lateral derecha en la pantalla.</p>" + "</div>"
	//Control Sidebar Skin Toggle
	 + "<div class='form-group'>" + "<label class='control-sidebar-subheading'>" + "<input type='checkbox' data-sidebarskin='toggle' class='pull-right'/> " + "Cambiar el Estilo de la Barra Lateral Derecha" + "</label>" + "<p>Fijar entre un estilo oscuro y claro la barra lateral derecha</p>" + "</div>");
	...
	$(".list-unstyled").before("<h4 class='control-sidebar-heading'>Estilos</h4>");
