...
class AdminLTEProvider extends ServiceProvider
{
    ...
    public function boot()
    {
      ...
      $this->publishes([
          __DIR__ . '/../../vendor/almasaeed2010/adminlte/bower_components/jquery/dist' => public_path('../resources/assets/adminlte/plugins/jquery/dist/'),
      ], 'public');

      $this->publishes([
          __DIR__ . '/../../vendor/almasaeed2010/adminlte/bower_components/fastclick/lib' => public_path('../resources/assets/adminlte/plugins/fastclick/lib/'),
      ], 'public');
    }
