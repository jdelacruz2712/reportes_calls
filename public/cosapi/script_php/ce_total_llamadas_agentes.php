...
$username = "admin";
$secret   = "admin";
$socket = fsockopen("flotante_asterisk_empresas","5038", $errornum, $errorstr);
$agents = array();
$curr_agent = "";
...
////////////////MANAGER2///////////////////
	...
	foreach( $agents as $agent=>$curr )
	{
	  ...
	  elseif(substr($curr['LoggedInChan'],0,5)=="Local")
	  {
		...
		$eventoactual  = " SELECT evento FROM empresas_reportes.HD_ESTADOACTUAL";
		...
		$total_llamadas_s  = " SELECT count(*) as total_llamadas from  empresas_qstats.queue_stats_mv"; 
		...
		$actualizar_total_llamadas  = " UPDATE empresas_reportes.CC_AGENTE ";
	...
	$upd_total_agentes="update empresas_reportes.CC_CONSOLIDADO set CC_AGENTES='".$total_agentes."'  , CC_AGENTES_CONECTADOS='".$agentes_conectados."'";
